...
public class RestauranteClient {
    ...
    public List<RestauranteResumoModel> listar() {
        try {
            ...
            RestauranteResumoModel[] restaurantes = this.restTemplate.getForObject(resourceUri, RestauranteResumoModel[].class);
    ...
    public RestauranteModel adicionar(RestauranteInput restauranteInput) {
        try {
            ...
            return this.restTemplate.postForObject(resourceUri, restauranteInput, RestauranteModel.class);
        } catch (RestClientResponseException e) {
            throw new ClientApiException(e.getMessage(), e);
        }
    }
